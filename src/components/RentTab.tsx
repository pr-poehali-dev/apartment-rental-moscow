...
export default function RentTab({
  ...
  const categoryListings: Apartment[] = [
    // Отели
    { id: 101, title: 'My loft Войковская', image: 'https://cdn.poehali.dev/projects/432e7c51-cea3-442e-b82d-2ac77f4ff46d/files/e5ab91c8-b024-4279-a610-7927a666ae1a.jpg', price: 4500, metro: 'Войковская', address: 'ул. Клары Цеткин, 18к3', area: 25, rooms: 1, telegram: '@myloft_voikovskaya', views: 0, telegramClicks: 0, lat: 55.818889, lon: 37.497222, category: 'hotels', minHours: 2 },
